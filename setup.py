...
name = 'trytonspain_account_invoice_discount'
download_url = 'https://bitbucket.org/trytonspain/trytond-account_invoice_discount'
...
setup(name=name,
    ...
    use_2to3=True,
    convert_2to3_doctests=['tests/scenario_invoice.rst'],
    )
